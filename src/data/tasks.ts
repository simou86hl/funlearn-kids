...
export const dailyTasks: Task[] = [
  ...
  { task_id: 'daily-game-2', title: 'Double Fun', description: 'Play 2 games today', type: 'game', target: 2, reward_xp: 25, emoji: '🎯', category: 'daily' },
  { task_id: 'daily-perfect', title: 'Perfect Round', description: 'Get all answers correct in a quiz', type: 'score', target: 100, reward_xp: 50, emoji: '💎', category: 'daily' },
];
export const weeklyTasks: Task[] = [
  ...
  { task_id: 'weekly-streak-7', title: 'Week Warrior', description: 'Maintain a 7-day streak', type: 'streak', target: 7, reward_xp: 200, emoji: '⚔️', category: 'weekly' },
  { task_id: 'weekly-all-games', title: 'Game Collector', description: 'Play all 12 games at least once', type: 'game', target: 12, reward_xp: 200, emoji: '🎰', category: 'weekly' },
];
